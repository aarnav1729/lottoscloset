  ...
  return (
    <div className={styles.root}>
      <div className={styles.section}>
        ...
        <p>
          Lotto's Closet (Minnesota Based) collects personal
          information that you voluntarily provide when applying or registering
          for an account with Lotto's Closet or making a purchase on The Lotto's Closet
          website; https://lottoscloset.netlify.app/ (our official website).
        </p>
        <p>
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          13, the registration process for The Lotto's Closet website cannot be
        ...
        <p>
          Lotto's Closet collects, uses and discloses information regarding users
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          celebrities), entity, a Lotto's Closet employee, or a civic or government
          leader, or otherwise misrepresent your affiliation with a person or
          entity. Lotto's Closet reserves the right to reject or block any user
        ...
        <p>
          ...
          without the prior written agreement of Lotto's Closet;{' '}
        </p>
        <p>
